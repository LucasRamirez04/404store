...
import _store.promocion.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> manejarPromocionNoEncontrada(PromocionNoEncontradaException ex,
                                                                      HttpServletRequest request) {
    ...
    // Caso especial de promoción: cupón inactivo o expirado -> 400 Bad Request (no 404, porque sí existe, solo no es válido)
    @ExceptionHandler(PromocionInvalidaException.class)
    public ResponseEntity<ErrorResponse> manejarPromocionInvalida(PromocionInvalidaException ex,
                                                                  HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
